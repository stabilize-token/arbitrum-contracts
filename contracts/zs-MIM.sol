...
contract zsToken is ERC20("Stabilize Arbitrum Strategy MIM", "zs-MIM"), Ownable, ReentrancyGuard {
    ...
    // Token information
    // This wrapped token accepts only mim, but can return also usdc and usdt
    // MIM, USDC, USDT
    struct TokenInfo {
