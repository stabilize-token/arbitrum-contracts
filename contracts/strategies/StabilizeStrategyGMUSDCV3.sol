...
// File: contracts/strategies/StabilizeStrategyGMUSDCV3.sol
...
contract StabilizeStrategyGMUSDCV3 is Ownable {
    ...
    address constant GMX_EXCHANGE_ROUTER = address(0x69C527fC77291722b52649E45c838e41be8Bf5d5);
...
contract StabilizeStrategyProperties is Ownable, GasUtils, MarketUtils {
    ...
    address constant GMX_EXCHANGE_READER = address(0x5Ca84c34a381434786738735265b9f3FD814b824);
    address constant GMX_EXCHANGE_ROUTER = address(0x69C527fC77291722b52649E45c838e41be8Bf5d5);
    uint256 constant DIVISION_FACTOR = 100000;
