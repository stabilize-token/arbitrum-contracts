...
contract StabilizeArbMerkleDistributor is IMerkleDistributor {
    ...
    function recoverLostTokens() external {
        // This function is activated 90 days after contract is created and can be used by governance to retrieve tokens
        require(msg.sender == governance, "Not governance");
        require(now > deployedTime + 90 days, "Has not been at least 90 days before attempting to recover");
